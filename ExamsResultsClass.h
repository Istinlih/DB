...
public:
	...
	bool add(int sess, string itemName, bool zach, bool spec = 0) { //Для зачетов
		int mark = 0;
		if (zach)
			mark = 1;
		else
